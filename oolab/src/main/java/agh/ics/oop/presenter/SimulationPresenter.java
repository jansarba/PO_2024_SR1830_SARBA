...
public class SimulationPresenter implements MapChangeListener{
    ...
    public void updateBounds(){
        xMin=map.getBoundary().lowerLeft().getX();
        yMin=map.getBoundary().lowerLeft().getY();
        xMax=map.getBoundary().upperRight().getX();
        yMax=map.getBoundary().upperRight().getY();
    ...
    private void startSimulation(){
        ...
        List<MoveDirection> directions=optionsParser(moveList.split(" "));
